...
int main(void)
{
    ...
    SQWORD sqAns = 0;
    while(1) {
        SQWORD sqCurPage = (vecsqA[sqCur] - sqCur - 1) / sqInput_k + 1; 
        SQWORD sqNextBound = sqCurPage * sqInput_k + sqCur;

//        printf("%lld %lld %lld %lld\n", sqCur, vecsqA[sqCur], sqCurPage, sqNextBound);

        auto it = upper_bound(vecsqA.begin(), vecsqA.end(), sqNextBound);
        sqAns++;
        sqCur = it - vecsqA.begin();
