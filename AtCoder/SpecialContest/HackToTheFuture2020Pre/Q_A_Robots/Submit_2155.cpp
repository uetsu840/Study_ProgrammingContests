...
int main(void)
{
    ...
    while (!queSearch.empty()) {
        ...
        dfs(GetNextPos(searchEntry.posCur, d1), d1, bRobotRoute3);
        dfs(GetNextPos(searchEntry.posCur, d2), d2, bRobotRoute4);
    }
