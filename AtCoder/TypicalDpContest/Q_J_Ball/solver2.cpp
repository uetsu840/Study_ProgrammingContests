...
static DOUBLE calcExVal(DWORD dwObjMap)
{
    ...
    for (DWORD dwTargetPosIdx = 1; dwTargetPosIdx < 1 + OBJ_POS_NUM; dwTargetPosIdx++) {
        ...
        switch(dwNeighbor) {
        case 0:
            adExValTmp[dwTargetPosIdx - 1] = INFINITY;
            break;
        case 1:
        case 2:
        case 4:
            {
                ...
                adExValTmp[dwTargetPosIdx - 1] = 3 + calcExVal(dwObjMapOnHit); 
            }
            break;
        case 3:
        case 5:
        case 6:
            {
                adExValTmp[dwTargetPosIdx - 1] = dp_2bit(dwObjMap, dwNeighbor, dwTargetPosIdx);
            }
            break;
        case 7:
            {
                adExValTmp[dwTargetPosIdx - 1] = dp_3bit(dwObjMap, dwNeighbor, dwTargetPosIdx);
            }
            break;
        default:
            printf("ERR\n");
