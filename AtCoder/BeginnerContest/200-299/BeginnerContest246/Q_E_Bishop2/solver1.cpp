...
int main(void)
{
    ...
    typedef pair<SQWORD, BOARD_POS> P;
    ...
    que.push(make_pair(0, BOARD_POS(sqAx, sqAy)));
    s_aasqCost[sqAx][sqAy] = 0;
        ...
        if (p.first <= sqCurCost) {
            for (auto m: moveDir) {
                ...
                while (1) {
                    ...
                    if (s_aasqCost[sqNextRow][sqNextCol] > sqCurCost + 1) {
                        s_aasqCost[sqNextRow][sqNextCol] = sqCurCost + 1;
                        que.push(P(sqCurCost+1, BOARD_POS{sqNextRow, sqNextCol}));
                    }
                    sqOfs++;
                }
            }
