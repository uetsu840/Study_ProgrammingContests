...
int main(void)
{
    ...
    SQWORD sqCnt3 = getCnt(vecsqDiv, 3 - 1);
    SQWORD sqCnt5 = getCnt(vecsqDiv, 5 - 1);
    SQWORD sqCnt15 = getCnt(vecsqDiv, 15 - 1);
    SQWORD sqCnt25 = getCnt(vecsqDiv, 25 - 1);
    SQWORD sqCnt75 = getCnt(vecsqDiv, 75 - 1);

    SQWORD sqAns = ((sqCnt5 * (sqCnt5 - 1)) / 2) * (sqCnt3 - 2)
                    + (sqCnt25 * (sqCnt3 - 1))
                    + (sqCnt15 * (sqCnt5 - 1))
                    + sqCnt75;
    printf("%lld\n", sqAns);
