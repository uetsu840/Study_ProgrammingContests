    ...
    SQWORD sqCnt)
{
    ...
    for (auto a: vsqA) {
        sqNeedCnt += ((a + (sqLength - 1)) / sqLength - 1); 
...
#define MAX_ANS     (100100100100100100)
...
int main(void)
{
    ...
    SQWORD sqAns = binarySearch(isDivisible, -1, MAX_ANS, vsqA, sqK);
