...
static DWORD ufGetParent(const ST_UNION_FIND *pstUf, DWORD dwIdx)
{
    return *(pstUf->pdwPar + dwIdx);
}

static DWORD ufGetRank(const ST_UNION_FIND *pstUf, DWORD dwIdx)
{
    return *(pstUf->pdwRank + dwIdx);
}

static void ufSetParent(const ST_UNION_FIND *pstUf, DWORD dwIdx, DWORD dwParent)
{
...
static DWORD ufGetRoot(const ST_UNION_FIND *pstUf, DWORD dwIdx)
{
...
static void ufUnite(ST_UNION_FIND *pstUf, DWORD dwX, DWORD dwY)
{
...
static M_BOOL ufIsSame(const ST_UNION_FIND *pstUf, DWORD dwX, DWORD dwY)
{
...
int main()
{
    ...
    static DWORD adwParents[CITY_INFO_ARY_SIZE];
    static DWORD adwRank[CITY_INFO_ARY_SIZE];
    static DWORD adwCnt[CITY_INFO_ARY_SIZE];

    ST_UNION_FIND stUf;

    initUnionFind(&stUf, adwParents, adwRank, adwCnt, ArrayLength(adwParents));
