...
#define PNT_NO_OFFSET_CG_OUT    (100)   /* 101-200 */
...
int main()
{
    ...
    Flow solverFlow;
    for (DWORD dwIdx = 0; dwIdx < dwInput_E; dwIdx++) {
        solverFlow.addEdge(s_astRelations[dwIdx].lA, 
                            s_astRelations[dwIdx].lB,
                            1, DUMMY_COST);
        solverFlow.addEdge(s_astRelations[dwIdx].lB,
                            s_astRelations[dwIdx].lA,
                            1, DUMMY_COST); 
    }
    for (DWORD dwIdx = 0; dwIdx < dwInput_G; dwIdx++) {
        solverFlow.addEdge(s_alCheckedGirls[dwIdx],
                            s_alCheckedGirls[dwIdx] + PNT_NO_OFFSET_CG_OUT,
                            1, DUMMY_COST);
    }

    for (DWORD dwIdx = 0; dwIdx < dwInput_G; dwIdx++) {
        solverFlow.addEdge(s_alCheckedGirls[dwIdx] + PNT_NO_OFFSET_CG_OUT,
                            PNT_NO_TARGET,
                            1, DUMMY_COST);
    }
    DWORD dwMaxFlow = solverFlow.MaxFlow(0, PNT_NO_TARGET);
    printf("%d\n", dwMaxFlow);
