...
static SQWORD getScore(vector<vector<SQWORD>> &vvD, 
    SQWORD sqR1,
    SQWORD sqR2,
    SQWORD sqC1,
    SQWORD sqC2)
...
//        printf("\n");
    ...
    vector<SQWORD> vQueryAns(sqN * sqN + 1, -1);
        ...
        for (SQWORD sqR2 = sqR1 + 1; sqR2 <= sqN; sqR2++) {
            for (SQWORD sqC1 = 0; sqC1 < sqN; sqC1++) {
                for (SQWORD sqC2 = sqC1 + 1; sqC2 <= sqN; sqC2++) {
                    SQWORD sqA = (sqR2 - sqR1) * (sqC2 - sqC1);
                    SQWORD sqS = getScore(vvDSum, sqR1, sqR2, sqC1, sqC2);
                    vQueryAns[sqA] = max(vQueryAns[sqA], sqS);
                }                   
            }
        }
    }
